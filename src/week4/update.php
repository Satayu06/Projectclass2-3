<?php
    ...
    //ประการศตัวแปรสำหรับแก้ไขข้อมูล
    ...
    $update = "UPDATE 'members' SET 'id_stu' = 'id_stu', 'name' = '$name', 'nname' = '$nname', 'age' = '$age', 'phone' = '$phone', 'address' 'status' , '$status'
    WHERE 'members' , 'id' = '$id';";
